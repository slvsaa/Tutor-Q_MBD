            ...
            <div class="card-deck" style="margin: 50px 0;">
                <div class="card col-md-3" style="padding:10px;height: 600px">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text" style="text-align:justify">Tutor asal Rusia yang menyukai segala sesuatu mengenai biologi                   
                ...
                <div class="card col-md-3" style="padding:10px">
                    ...
                    <div class="card-body">
                        <h5 class="card-title" style="text-align:center"><b>Ayu Yamazaka</b></h5>
                ...
                <div class="card-deck" style="margin: 50px 0;">
                    ...
                    <div class="card col-md-3" style="padding:10px">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text" style="text-align:justify">Sebuah kebanggaan bisa menjadi tutor sejarah menurut tutor
                    ...
                    <div class="card col-md-3" style="padding:10px;height:600px">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text" style="text-align:justify">Cerdas dan ramah menjadi ciri khas tutor asal Amerika yang suka
